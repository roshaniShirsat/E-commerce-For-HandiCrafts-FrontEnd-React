...
export const getOrders = (reqData) => {
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const response = await api.get(`/api/admin/ordersItems/`);
...
export const confirmOrder = (orderId) => async (dispatch) => {
  ...
  try {
    const response = await api.put(
      `/api/admin/ordersItems/${orderId}/confirmed`
    );
...
export const shipOrder = (orderId) => {
  return async (dispatch) => {
    try {
      ...
      const {data} = await api.put(`/api/admin/ordersItems/${orderId}/ship`);
...
export const deliveredOrder = (orderId) => async (dispatch) => {
  ...
  try {
    const response = await api.put(
      `/api/admin/ordersItems/${orderId}/deliver`
    );
    const data = response.data;
...
export const cancelOrder = (orderId) => async (dispatch) => {
  ...
  try {
    const response = await api.put(
      `/api/admin/ordersItems/${orderId}/cancel`
    );
    const data = response.data;
...
export const deleteOrder = (orderId) => {
  return async(dispatch) => {
   ...
   try {
     const {data} = await api.delete(`/api/admin/ordersItems/${orderId}/delete`);
