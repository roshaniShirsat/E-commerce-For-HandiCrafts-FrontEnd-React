...
import { deleteProduct, findProducts, findProductsByUser } from "../../../Redux/Customers/Product/Action";
    ...
    <Box width={"100%"}>
      ...
      <Card className="mt-2">
        ...
        <TableContainer>
          <Table sx={{ minWidth: 800 }} aria-label="table in dashboard">
            ...
            <TableBody>
              {customersProduct?.productListByUser?.content?.map((item) => (
                <TableRow
                  hover
                  key={item.name}
      ...
      <Card className="mt-2 border">
        ...
        <div className="mx-auto px-4 py-5 flex justify-center shadow-lg rounded-md">
          <Pagination
            count={customersProduct.productListByUser?.totalPages}
            color="primary"
            className=""
            onChange={handlePaginationChange}
            // value={page}
