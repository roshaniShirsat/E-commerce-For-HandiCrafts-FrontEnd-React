    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + isLargeScreen, backgroundColor: 'rgb(0, 0, 22)' }}>
        <Toolbar>
          ...
          <Avatar alt="kalakriti" src="https://giveasmile.frappe.cloud/files/Kalakriti.png" onClick={() => {navigate("/")}} 
          sx={{cursor: "pointer"}}/>
          <Typography variant="h6" gutterBottom style={{padding:"0 15px 0 15px"}}>Seller's Hub</Typography>
          {/* <Search>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
