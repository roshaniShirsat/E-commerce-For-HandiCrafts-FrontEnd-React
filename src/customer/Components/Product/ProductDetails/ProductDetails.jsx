...
import { findProductByCategoryID, findProductById, findProducts } from "../../../../Redux/Customers/Product/Action";
...
export default function ProductDetails() {
  ...
  const similarProducts = customersProduct?.productListByCategory.filter(item => item.id!=productId);
  console.log("param--------------",productId,customersProduct);
  ...
  useEffect(() => {
    ...
    dispatch(findProductByCategoryID(data));
